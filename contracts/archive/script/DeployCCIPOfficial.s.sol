...
import {CCIPTransferConsumerOfficial} from "../src/CCIPTransferConsumerOfficial.sol";

/**
 * @title DeployCCIPOfficial
 * @notice Deploys CCIPConsumer matching official CRE template format
 */
contract DeployCCIPOfficial is Script {
    ...
    function run() external {
        ...
        console.log("===========================================");
        console.log("DEPLOYING CCIP CONSUMER (OFFICIAL FORMAT)");
        console.log("===========================================");
        ...
        // Deploy official format consumer
        CCIPTransferConsumerOfficial consumer = new CCIPTransferConsumerOfficial(
            USDA_V4_SEPOLIA,
            CCIP_ROUTER_SEPOLIA,
            deployer
        );
        ...
        console.log("===========================================");
        console.log("CCIPTransferConsumerOfficial:", address(consumer));
        console.log("\nNext steps:");
        ...
        console.log("5. Update workflow to use OFFICIAL report format");
    }
}
