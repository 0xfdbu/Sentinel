    ...
    <div className="w-full overflow-x-auto py-4">
      <svg viewBox="0 0 1000 700" className="w-full min-w-[900px]" style={{ height: 'auto' }}>
        ...
        <text x="500" y="50" textAnchor="middle" fill="#525252" fontSize="11" fontFamily="ui-monospace, monospace">
          Autonomous security guard with GoPlus + PoR + AI validation
        </text>
        ...
        {/* === STEP 1.5: GOPLUS SECURITY CHECK === */}
        <rect x="60" y="185" width="160" height="22" rx="11" fill="#171717" stroke="#404040" strokeWidth="1" />
        <text x="140" y="200" textAnchor="middle" fill="#a3a3a3" fontSize="9" fontWeight="500" fontFamily="ui-monospace, monospace">GoPlus Security Check</text>
        ...
        <text x="320" y="238" textAnchor="middle" fill="#737373" fontSize="9" fontWeight="500" fontFamily="ui-monospace, monospace">Address Analysis</text>
        <text x="320" y="258" textAnchor="middle" fill="#f472b6" fontSize="8" fontFamily="ui-monospace, monospace">Check from/to addresses</text>
        <text x="320" y="273" textAnchor="middle" fill="#525252" fontSize="7" fontFamily="ui-monospace, monospace">+30% to fraud score</text>

        {/* GoPlus risk indicators */}
        <rect x="430" y="215" width="200" height="65" rx="4" fill="#0a0a0a" stroke="#262626" strokeWidth="1" strokeDasharray="3,3" />
        <text x="530" y="235" textAnchor="middle" fill="#525252" fontSize="8" fontFamily="ui-monospace, monospace">Risk checks: honeypot (+40)</text>
        <text x="530" y="250" textAnchor="middle" fill="#525252" fontSize="8" fontFamily="ui-monospace, monospace">blacklist (+50), mintable (+15)</text>
        <text x="530" y="265" textAnchor="middle" fill="#525252" fontSize="8" fontFamily="ui-monospace, monospace">proxy (+10), low holders (+15)</text>
        ...
        <text x="530" y="393" textAnchor="middle" fill="#525252" fontSize="8" fontFamily="ui-monospace, monospace">to prevent undercollateralization</text>
        ...
        <text x="130" y="450" textAnchor="middle" fill="#a3a3a3" fontSize="9" fontWeight="500" fontFamily="ui-monospace, monospace">xAI Analysis</text>
        ...
        <text x="135" y="508" textAnchor="middle" fill="#525252" fontSize="8" fontFamily="ui-monospace, monospace">Threat assessment</text>
        ...
        <text x="320" y="508" textAnchor="middle" fill="#ef4444" fontSize="8" fontFamily="ui-monospace, monospace">🛑 PAUSE (score ≥ 80)</text>
        <text x="320" y="523" textAnchor="middle" fill="#22c55e" fontSize="8" fontFamily="ui-monospace, monospace">👁️ MONITOR (score &lt; 80)</text>

        {/* AI note */}
        <rect x="430" y="465" width="200" height="65" rx="4" fill="#0a0a0a" stroke="#262626" strokeWidth="1" strokeDasharray="3,3" />
        <text x="530" y="488" textAnchor="middle" fill="#525252" fontSize="8" fontFamily="ui-monospace, monospace">AI analyzes threat + GoPlus data</text>
        <text x="530" y="503" textAnchor="middle" fill="#525252" fontSize="8" fontFamily="ui-monospace, monospace">Fraud score includes +30% from</text>
        <text x="530" y="518" textAnchor="middle" fill="#525252" fontSize="8" fontFamily="ui-monospace, monospace">GoPlus security check</text>

        <line x1="320" y1="530" x2="320" y2="545" stroke="#404040" strokeWidth="1.5" markerEnd="url(#arr-sg-step)" />

        {/* === STEP 4: DON REPORT === */}
        <rect x="60" y="560" width="140" height="22" rx="11" fill="#171717" stroke="#404040" strokeWidth="1" />
        <text x="130" y="575" textAnchor="middle" fill="#a3a3a3" fontSize="9" fontWeight="500" fontFamily="ui-monospace, monospace">DON Report</text>
        ...
        <text x="135" y="633" textAnchor="middle" fill="#525252" fontSize="8" fontFamily="ui-monospace, monospace">keccak256(action+target)</text>
        <text x="135" y="648" textAnchor="middle" fill="#525252" fontSize="7" fontFamily="ui-monospace, monospace">Encode + DON sign</text>
        ...
        <text x="320" y="613" textAnchor="middle" fill="#fb923c" fontSize="10" fontWeight="500" fontFamily="ui-monospace, monospace">EmergencyGuardian</text>
        <text x="320" y="633" textAnchor="middle" fill="#525252" fontSize="8" fontFamily="ui-monospace, monospace">onReport(metadata, report)</text>
        ...
        <text x="495" y="638" textAnchor="middle" fill="#525252" fontSize="8" fontFamily="ui-monospace, monospace">Vault secured</text>
